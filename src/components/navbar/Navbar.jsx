  ...
  return (
    <div className=' fixed w-full z-50'>
      <nav className="bg-white border-gray-200 dark:bg-white">
        <div className="flex flex-wrap justify-between items-center my-auto mx-auto max-w-screen-xl py-1 px-5 gap-5">
          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            <div className="flex items-center justify-center my-auto lg:gap-10 gap-5">
              <a href="https://wa.me/8420566770" className="h-full">
          ...
          <div className="flex justify-between">
            <ul
              className={`${isMobileNavOpen ? 'flex' : 'hidden'
                } lg:flex flex-col text-2xl md:text-lg gap-8 md:gap-10 lg:flex-row lg:flex-grow max-w-6xl`}
            >
              <li className="mt-4 lg:inline-block lg:mt-0">
                <a href="#overview" className="block text-white-200 whitespace-nowrap">
                  OVERVIEW
                </a>
              </li>
              <li className="mt-4 lg:inline-block lg:mt-0">
                <a href="#key-highlights" className="block text-white-200 whitespace-nowrap">
                  KEY HIGHLIGHTS
                </a>
              </li>
              <li className="mt-4 lg:inline-block lg:mt-0">
                <a href="#amenities" className="block text-white-200 whitespace-nowrap">
                  AMENITIES
                </a>
              </li>
              <li className="mt-4 lg:inline-block lg:mt-0">
                <a href="#location" className="block text-white-200 whitespace-nowrap">
                  LOCATION
                </a>
              </li>
              <li className="mt-4 lg:inline-block lg:mt-0">
                <a href="#contact" className="block text-white-200 whitespace-nowrap">
                  CONTACT US
                </a>
              </li>
              <li className="mt-4 lg:inline-block lg:mt-0">
                <a href="#site-plan" className="block text-white-200  whitespace-nowrap">
                  SITE PLAN
                </a>
              </li>
              <li className="mt-4 lg:inline-block lg:mt-0">
                <a href="#location-perks" className="block text-white-200 whitespace-nowrap">
                  LOCATION PERKS
                </a>
              </li>
            </ul>
