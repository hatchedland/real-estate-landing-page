    ...
    <section id='overview' className='py-32 lg:py-40 px-5 lg:px-10 max-w-7xl mx-auto'>
      <div className='flex flex-col lg:flex-row w-full justify-center gap-10'>
        <div className='lg:w-1/2 flex-grow flex flex-col gap-10'>
          <div>
            <PageTitle title="Overview" tagline="Happiness Begin at Home" />
            ...
            <a href='#contact' onClick={brochureFunction}><button type="button" class="text-black border-2 border-black hover:bg-black hover:text-white focus:outline-none px-5 py-3 text-center my-10 me-2 flex gap-2" ><DownloadCircle /><span>Download Brochure</span></button></a>
